...
<html>
  <head>
    ...
    <!-- Theme style -->
    <link href="../../../public/assets/dist/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
    <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
          page. However, you can choose any other skin. Make sure you
          apply the skin class to the body tag so the changes take effect.
    -->
    <link href="../../../public/assets/dist/css/skins/skin-blue.min.css" rel="stylesheet" type="text/css" />
  ...
  <body class="skin-blue sidebar-mini">
    ...
    <!-- AdminLTE App -->
    <script src="../../../public/assets/dist/js/app.min.js" type="text/javascript"></script>
